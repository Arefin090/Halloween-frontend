  ...
  return (
    <PageContainer id="formSection">
      <FormContainer>
        ...
        <Paragraph>Transform your house into a haunted ghoulish area this Halloween season! Upon joining the Spooktacular event, our team will make sure that your house will be easily located on the map. 🍫 ​By adding your address to the map, you agree to the <span style={{ color: '##FFFFFF', cursor: 'pointer', textDecoration: 'underline' }} onClick={handleTermsClick}>Spooky Fine Print</span>.</Paragraph>
